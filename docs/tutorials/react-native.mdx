...
![Finished app](/img/tutorials/rn_full_app.gif)
...
You'll also need to install [Reanimated library](https://docs.swmansion.com/react-native-reanimated/docs/fundamentals/getting-started) and [React Navigation](https://reactnavigation.org/)
:::tip
Run `pod install` in the /ios directory to install the new pods
:::
...
![Room screen](/img/tutorials/room_screen.png)
