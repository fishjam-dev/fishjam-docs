...
For each server, Jellyfish collects webRTC-like data about the rooms, clients and streamed tracks. You can see them in the dashboard using the **Internals** button.

![Internals button](/img/tutorials/dashboard/dashboard_internals_button.png)

The button opens a new tab with the panel to connect to the WebSocket of the room of choice.
