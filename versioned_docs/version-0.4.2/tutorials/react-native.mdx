...
If you want to skip creating and setuping app clone this [repo](https://github.com/karkakol/react-native-jellyfish-example-begin-0.1.6). Then continue from this [step](#screens).

If you want ready to use app just clone and run this [repo](https://github.com/karkakol/react-native-jellyfish-example-end-0.1.6). Remember to change your [server url](https://github.com/karkakol/react-native-jellyfish-example-end-0.1.6/blob/5ef7d7ac6146d3d631598c2f6168d5dc591a1377/screens/Connect.tsx#L22).
:::
...
```bash
npx react-native@latest init ReactNativeJellyfishExample && cd ReactNativeJellyfishExample
```
...
```bash
npx react-native init ReactNativeJellyfishExample --template react-native-template-typescript && cd ReactNativeJellyfishExample
```
...
<Tabs>
  <TabItem value="react-native" label="React Native">
    ...
    package introduces a small footprint, but is necessary as the Jellyfish client
...
Screencast requires additional configuration, you can find the details [here](https://github.com/jellyfish-dev/react-native-client-sdk#ios). To keep this tutorial simple, we will skip this step.
...
// for simplicity.
// If you use secure connection with your Jellyfish Media Server change ws to wss in this variable.
// highlight-next-line
...
This video shows how to connect to Jellyfish dashboard, create room and peers.
...
a video from your camera in the front-end dashboard.
...
<ImageWrapper url={"/react_native/add_track_in_jellyfish.gif"} />
