...
If you want to skip initialization of app clone this [repo](https://github.com/karkakol/react-native-jellyfish-example-begin-0.1.6).

If you want ready app clone and run this [repo](https://github.com/karkakol/react-native-jellyfish-example-end-0.1.6).
:::
