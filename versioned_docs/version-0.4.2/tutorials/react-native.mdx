...
This image shows how you can obtain and use peer token.
...
You can add another participant and their new track (displaying for example rotating heart) in the dashboard like
this (for this version of mobile sdk 0.1.6 remember check attach metadata checkbox) :
