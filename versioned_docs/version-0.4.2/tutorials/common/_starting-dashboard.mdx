...
or connections to localhost. Any insecure requests (http/ws) will be automatically blocked by the browser. For testing purposes we recommend to use Chrome browser. Otherwise without secure connection you may encounter problems with connecting to Jellyfish server.
